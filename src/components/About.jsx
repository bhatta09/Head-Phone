    ...
    <div className='min-h-screen flex flex-col lg:flex-row items-center justify-between lg:px-32 px-5 pt-6'>
      ...
      <div className='w-full lg:w-2/4 space-y-4'>
        ...
        <h2 className='text-2xl font-medium pt-4'>
          Experience audio redefined. Our headsets deliver quality, comfort, 
          and style in every note.
          </h2>
      <p className='text-sm'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat
         magnam, praesentium temporibus tenetur earum nisi architecto
          iste quo recusandae laborum.
          </p>
